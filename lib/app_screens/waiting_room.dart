                ...
                Align(
                  ...
                  child:ElevatedButton(
                      onPressed: () async{
                         ...
                         Navigator.push(
                           context,
                           MaterialPageRoute(builder: (context) => GamePlay(room: roomParticipants, roomId: roomId, pointsCollection: pointsCollection,isAdmin: isAdmin,Name:Name,playerList:listp)),
                         );
                    },
                    child: Text("START"),
                  ),
  ...
  void shift(){
    roomParticipants.snapshots().listen((snapshot) {
      ...
      if(check!=null && check.get('isPressed')==true){
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => GamePlay(room: roomParticipants, roomId: roomId, pointsCollection: pointsCollection,isAdmin: isAdmin,Name:Name,playerList:List)),
        );
      }
    });
  }
