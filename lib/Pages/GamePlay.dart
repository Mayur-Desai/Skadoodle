...
import 'package:skadoodlem/Pages/components/Canvas.dart';
import 'package:provider/provider.dart';
                      ...
                      Flexible(
                          child: new FirebaseAnimatedList(
                              ...
                              itemBuilder: (BuildContext context,DataSnapshot snapshot,Animation<double> nimation,int index){
                                ...
                                return new ListTile(
                                  tileColor: data[n]=='has guessed the word!'?Colors.green:Colors.white,
                                  title: Text(n),
                                  trailing: Text(data[n]),
                                );
                              }
                          )
                      )
                  ...
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      onSubmitted: (val) async {
                        setState(()  {
                          guess=val;
                          if(guess.similarityTo(word_choose.toLowerCase())>=0.6){
                            showToast();
                          }
                          chats.push().set({
                            Name:guess==word_choose.toLowerCase()?'has guessed the word!':guess,
