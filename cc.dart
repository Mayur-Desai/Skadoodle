...
class Draw extends StatefulWidget{
  ...
  Draw({required this.roomId,required this.isDrawing});
  @override
  _DrawState createState() => _DrawState(roomId: roomId,isDrawing:isDrawing);
...
class _DrawState extends State<Draw>{
  ...
  _DrawState({required this.roomId,required this.isDrawing});
